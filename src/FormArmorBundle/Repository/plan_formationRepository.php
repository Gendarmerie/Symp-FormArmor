...
{
  public function listePlansFormation($page, $nbParPage) // Liste toutes les sessions avec pagination
	{
	...
	public function suppPlanFormation($id) // Suppression de la session d'identifiant $id
	{
		$qb = $this->createQueryBuilder('pF');
		$query = $qb->delete('FormArmorBundle\Entity\Plan_formation', 's')
		  ->where('s.id = :id')
		  ->setParameter('id', $id);
